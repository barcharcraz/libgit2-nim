...
template GIT_ATTR_TRUE*(attr: untyped): untyped =
  (git_attr_value(attr) == GIT_ATTR_TRUE_T)
...
template GIT_ATTR_FALSE*(attr: untyped): untyped =
  (git_attr_value(attr) == GIT_ATTR_FALSE_T)
...
template GIT_ATTR_UNSPECIFIED*(attr: untyped): untyped =
...
template GIT_ATTR_HAS_VALUE*(attr: untyped): untyped =
  (git_attr_value(attr) == GIT_ATTR_VALUE_T)
